  ...
  >
    ...
    >
      ...
      >
        ...
        <div
          class="btn btn-icon w-auto ps-0 btn-active-color-primary d-lg-inline-flex me-2 me-lg-5"
                  ...
                  <div class="scroll-y mh-200px mh-lg-350px">
                      ...
                      <div class="symbol symbol-40px me-4">
                        <span class="symbol-label bg-light">
                          <!-- <img class="w-20px h-20px"
																			src="/craft/assets/media/svg/brand-logos/volicity-9.svg" alt=""> -->
                        </span>
                      </div>
                      <!--end::Symbol-->
                    ...
                    >
                      ...
                      <div class="symbol symbol-40px me-4">
                        <span class="symbol-label bg-light">
                          <!-- <img class="w-20px h-20px"
																			src="/craft/assets/media/svg/brand-logos/tvit.svg" alt=""> -->
                        </span>
                      </div>
                      <!--end::Symbol-->
                    ...
                    >
                      ...
                      <div class="symbol symbol-40px me-4">
                        <span class="symbol-label bg-light">
                          <!-- <img class="w-20px h-20px"
																			src="/craft/assets/media/svg/misc/infography.svg" alt=""> -->
                        </span>
                      </div>
                      <!--end::Symbol-->
                    ...
                    >
                      ...
                      <div class="symbol symbol-40px me-4">
                        <span class="symbol-label bg-light">
                          <!-- <img class="w-20px h-20px"
																			src="/craft/assets/media/svg/brand-logos/leaf.svg" alt=""> -->
                        </span>
                      </div>
                      <!--end::Symbol-->
                    ...
                    >
                      ...
                      <div class="symbol symbol-40px me-4">
                        <span class="symbol-label bg-light">
                          <!-- <img class="w-20px h-20px"
																			src="/craft/assets/media/svg/brand-logos/tower.svg" alt=""> -->
                        </span>
                      </div>
                      <!--end::Symbol-->
              ...
              >
                ...
                <div class="mb-5">
                  <select
                    ...
                    data-select2-id="select2-data-1-ney1"
                    tabindex="-1"
                    aria-hidden="true"
                    data-kt-initialized="1"
                  >
                    <option value="next" data-select2-id="select2-data-3-jkpx">
                      Within the next
                    </option>
                  ...
                  ><span
                    ...
                    dir="ltr"
                    data-select2-id="select2-data-2-eow1"
                    style="width: 100%"
                ...
                <div class="row mb-8">
                  ...
                  <div class="col-6">
                    <select
                      ...
                      class="form-select form-select-sm form-select-solid select2-hidden-accessible"
                      data-select2-id="select2-data-4-6ynm"
                      tabindex="-1"
                      aria-hidden="true"
                      data-kt-initialized="1"
                    >
                      <option
                        value="days"
                        data-select2-id="select2-data-6-cjmm"
                      >
                        Days
                      </option>
                    ...
                    ><span
                      class="select2 select2-container select2-container--bootstrap5"
                      dir="ltr"
                      data-select2-id="select2-data-5-p4wo"
                      style="width: 100%"
                      ><span class="selection"
                        ><span
                          class="select2-selection select2-selection--single form-select form-select-sm form-select-solid"
                          ...
                          tabindex="0"
                          aria-disabled="false"
                          aria-labelledby="select2-date_typer-35-container"
                          aria-controls="select2-date_typer-35-container"
                          ><span
                            class="select2-selection__rendered"
                            id="select2-date_typer-35-container"
                            role="textbox"
                            aria-readonly="true"
                            title="Days"
                            >Days</span
                ...
                <div class="d-flex justify-content-end">
                  ...
                  <a
                    href="/craft/pages/search/horizontal.html"
        ...
        <div class="d-flex align-items-stretch flex-shrink-0">
          ...
          <div class="d-flex align-items-center ms-1 ms-lg-2">
            ...
            >
              ...
              <div
                ...
                style="
                  background-image: url('/craft/assets/media/misc/menu-header-bg.jpg');
                "
              >
                <!--begin::Title-->
              ...
              <div class="row g-0">
                ...
                <div class="col-6">
                  <a
                    href="/craft/apps/projects/budget.html"
                ...
                <div class="col-6">
                  <a
                    href="/craft/apps/projects/settings.html"
                ...
                <div class="col-6">
                  <a
                    href="/craft/apps/projects/list.html"
                ...
                <div class="col-6">
                  <a
                    href="/craft/apps/projects/users.html"
              ...
              <div class="py-2 text-center border-top">
                <a
                  href="/craft/pages/user-profile/activity.html"
                  ...
                  <div class="d-flex flex-column px-9">
                    ...
                    <div class="text-center px-4">
                      <!-- <img class="mw-100 mh-200px" alt="image"
																	src="/craft/assets/media/illustrations/sigma-1/1.png"> -->
                    </div>
                    <!--end::Illustration-->
                  </div>
                  <!--end::Wrapper-->
          ...
          >
            ...
            >
              ...
              <nuxt-img src="/img/avatar-default.png" />
            </div>
            ...
            >
              ...
              <div class="menu-item px-5">
                <a href="/craft/account/overview.html" class="menu-link px-5">
                  My Profile
                </a>
              </div>
              <!--end::Menu item-->
              ...
              <!--begin::Menu item-->
              <div class="menu-item px-5">
                <a href="/craft/apps/projects/list.html" class="menu-link px-5">
              ...
              >
                ...
                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                  ...
                  <div class="menu-item px-3">
                    <a
                      href="/craft/account/referrals.html"
                  ...
                  <div class="menu-item px-3">
                    <a
                      href="/craft/account/statements.html"
                      class="menu-link px-5"
                    >
                      Payments
                    </a>
              ...
              <!--begin::Menu item-->
              <div class="menu-item px-5">
                <a href="/craft/account/statements.html" class="menu-link px-5">
                  My Statements
                </a>
              </div>
              <!--end::Menu item-->
              ...
              >
                  ...
                  <span class="menu-title position-relative">
                    ...
                    >
                      ...
                      <!-- <img class="w-15px h-15px rounded-1 ms-2"
																	src="/craft/assets/media/flags/united-states.svg" alt=""> -->
                    </span>
                  </span>
                </a>
                ...
                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                  ...
                  <div class="menu-item px-3">
                    <a
                      href="/craft/account/settings.html"
                      class="menu-link d-flex px-5 active"
                    >
                      <span class="symbol symbol-20px me-4">
                        <!-- <img class="rounded-1" src="/craft/assets/media/flags/united-states.svg"
																		alt=""> -->
                      </span>
                      English
                    </a>
              ...
              <div class="menu-item px-5 my-1">
                <a href="/craft/account/settings.html" class="menu-link px-5">
                  Account Settings
                </a>
              </div>
              <!--end::Menu item-->
              <div class="menu-item px-5 my-1">
                <NuxtLink to="/changePass" class="menu-link px-5">Change password</NuxtLink>
              </div>
